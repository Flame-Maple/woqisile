...
public class Analyser {
    ...
    private void addStdioFunctionInstruction(String name){
    ...
    public static String getPos(){
        return "row: "+t.getThisToken().getStartPos().getRow()+" col:"+t.getThisToken().getStartPos().getCol();
    }
    ...
    public boolean isCreatingFunction() {
        return isCreatingFunction;
    }

    public void setCreatingFunction(boolean creatingFunction) {
        isCreatingFunction = creatingFunction;
    }
    ...
    public static String[] getStdio() {
        return stdio;
    }

    public static void setStdio(String[] stdio) {
        Analyser.stdio = stdio;
    }
}