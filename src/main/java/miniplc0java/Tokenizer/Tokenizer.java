...
public class Tokenizer {
    ...
    public Token expectToken(TokenType tokenType){
        ...
        throw new Error("row: "+peekToken().getStartPos().getRow()+" col:"+peekToken().getStartPos().getCol());
    }
    ...
    public ArrayList<Integer> getSavedPoint() {
        return savedPoint;
    }

    public void setSavedPoint(ArrayList<Integer> savedPoint) {
        this.savedPoint = savedPoint;
    }

    public CharReader getC() {
        return c;
    }

    public void setC(CharReader c) {
        this.c = c;
    }
